...
def run_apMDP(init_loc, ltl_formula, cube_env, ap_maps, verbose=False):
    start_time = time.time()
...
if __name__ == '__main__':
    ...
    for num_case in [4]:
        ...
        for i in range(int(run_num)):
            ...
            t, l, _, _,_, backup= run_apMDP(init_loc, ltl_formula, cube_env1, ap_maps, verbose=flag_verbose)
