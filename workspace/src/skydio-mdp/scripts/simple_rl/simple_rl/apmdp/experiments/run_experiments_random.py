...
from simple_rl.apmdp.AP_MDP.RoomCubePlainMDPClass import RoomCubePlainMDP
...
from simple_rl.apmdp.experiments.run_experiments import run_plain_pMDP, run_apMDP, run_aMDP_lowest
...
if __name__ == '__main__':
    ...
    for i in range(0, NUM_SIMULATE):
        ...
        t, l, flag_success, _, _, backup_num = run_apMDP(init_loc, ltl_formula, cube_env, ap_maps, verbose=flag_verbose)
