...
class MagicRocket(Skill):
    ...
    def __init__(self):
        super(MagicRocket, self).__init__() #gives access to functions in superclasses
    ...
    def box(self, api): 
        ...
        nav_edge_1 = Transform(
                rotation = curr_location_flat.rotation(),
                translation = curr_location_flat * np.array([0,0, 18])
        )
